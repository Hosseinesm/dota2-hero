      ...
      <div className="relative bg-slate-900 w-full max-w-5xl h-[90vh] rounded-2xl border border-slate-700 shadow-2xl overflow-hidden flex flex-col lg:flex-row animate-[fadeIn_0.3s_ease-out]">
        ...
        <div className="lg:w-3/5 h-2/3 lg:h-full bg-slate-800 p-6 lg:p-10 overflow-y-auto">
           ...
           {loadingAi ? (
             ...
             <div className="flex flex-col items-center justify-center h-full text-slate-500 p-8 text-center bg-slate-900/50 rounded-xl border border-slate-800">
                ...
                <p className="text-lg font-bold text-slate-300 mb-2">متاسفانه اطلاعات دریافت نشد.</p>
                <p className="text-sm text-slate-400 mb-6">این مشکل معمولاً به دلیل فیلترینگ یا کندی اینترنت رخ می‌دهد.</p>
                <div className="bg-blue-900/20 text-blue-300 p-3 rounded text-sm mb-6 border border-blue-500/20">
                  پیشنهاد: VPN خود را روشن یا تعویض کنید و دوباره تلاش کنید.
                </div>
                <button 
                  onClick={() => onClose()} 
                  className="px-6 py-2 bg-slate-700 rounded-lg hover:bg-slate-600 text-white transition-colors"
                >
                  بازگشت
                </button>
             </div>
